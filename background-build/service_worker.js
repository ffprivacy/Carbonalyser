...
computeEquivalenceFromStatsItem = async (stats) => {
    ...
    res.gCO2Total = regions[DEFAULT_REGION] === undefined ? 0 : Math.round(regions[DEFAULT_REGION].carbonIntensity * cloudKWh + regions[selectedRegion].carbonIntensity * kWhDeviceTotal);
...
getEmptyStatsObject = () => {
    return {equivalence: getEmptyEquivalenceObject(), stats: 
        ...
        forecast: {
            ...
            dayRategCO2e: 0 // daily gCO2e rate
        }
    };
}
...
startPeriodicIfNeeded();
// background-src/sitesUpdater.js
