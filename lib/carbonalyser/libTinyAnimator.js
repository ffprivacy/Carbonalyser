...
const rotateAnimation = {
    ...
    onAnimationEnd: async function() {                    // called on animation end
      obrowser.runtime.sendMessage({action: "recomputeStats"});
    },
    newInstance: function () {
        return Object.assign({}, this);
    }
}
const rotateAnimationDummy = {};
Object.assign(rotateAnimationDummy, rotateAnimation);
rotateAnimationDummy.durationMs = 0;